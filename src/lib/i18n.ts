...
export const ui = {
  fr: {
    ...
    'yesno.inclination': 'Inclinaison',
    'yesno.level.0': 'Non franc',
    'yesno.level.1': 'Plutôt non',
    'yesno.level.2': 'Incertain',
    'yesno.level.3': 'Plutôt oui',
    'yesno.level.4': 'Oui franc',
    'yesno.caveat':
      'Le tarot éclaire, il ne tranche pas : lis cette inclinaison comme une invitation à réfléchir, pas comme un verdict.',
  ...
  en: {
    ...
    'spread.quintessence': 'Quintessence',
    'yesno.inclination': 'Leaning',
    'yesno.level.0': 'Clear no',
    'yesno.level.1': 'Leaning no',
    'yesno.level.2': 'Uncertain',
    'yesno.level.3': 'Leaning yes',
    'yesno.level.4': 'Clear yes',
    'yesno.caveat':
      'Tarot illuminates, it does not decide: read this leaning as an invitation to reflect, not as a verdict.',
